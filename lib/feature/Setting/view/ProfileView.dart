        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 40),
              Consumer<userViewModel>(
                builder: (context, value, child) => customerViewInfroProfile(
                  subTitel: "${value.firstName} ${value.lastName}",
                  Titel: "NAME",
                  IconsInfro: Icon(
              ...
              Selector<userViewModel, double>(
                ...
                selector: (context, value) => value.BalanceGet,
              ),
              SizedBox(height: 15),
              ...
              SizedBox(height: 7),
              Selector<userViewModel, List<Map>>(
                builder: (context, value, child) => value.length == 0
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) =>
                            customerCardViewBankLinked(
                              title: "${value[index]["bankName"]}",
                              subtitle: "${value[index]["bankNumber"]}",
                            ),
                      ),
