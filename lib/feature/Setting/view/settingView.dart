      ...
      Scaffold(backgroundColor: appColors.bgLight,
        ...
        body: Container(
          ...
          child: Column(
            children: [
              SizedBox(height: 10,),
              customerViewSettings(actionDo: (){
                Navigator.of(context).pushNamed(namePages.profileView);
              },
                title: "Profile",
                iconItemSetting: Icon(Icons.person,color:
                appColors.secondary,size: 26,),),
              SizedBox(height: 15,),
              customerViewSettings(actionDo: (){
                customerBottomSheetLang _customerBottomSheet=customerBottomSheetLang();
                _customerBottomSheet.showBottomSheetLang(context);


           },
                title: "Language",
                iconItemSetting: Icon(Icons.language,color:
                appColors.secondary,size: 26,),),
              SizedBox(height: 15,),
              customerViewSettings(actionDo: (){
                print('object');
                ...
                title: "Securety",
                iconItemSetting: Icon(Icons.lock,color:
                appColors.secondary,size: 26,),),
              SizedBox(height: 15,),
              customerViewSettings(actionDo: (){
Navigator.of(context).pushNamed(namePages.notificationPage);              },
                title: "Notifications",
                iconItemSetting: Icon(Icons.notifications,color:
                appColors.secondary,size: 26,),),
SizedBox(height: 10,),
              Divider(
...
Navigator.of(context).popAndPushNamed(namePages.login);
                  ...
                  title:Text('Logout',style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                      fontWeight: FontWeight.bold,color: appColors.error,
                      fontSize: 16.sp
                  ),) ,
                  leading:    CircleAvatar(
                      backgroundColor: appColors.bgIconError,
                      child: Icon(Icons.logout_outlined,size: 26,color: appColors.error,))
