              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Time", style: Textthemelight.textTheme.bodySmall),
                      Text(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Fee", style: Textthemelight.textTheme.bodySmall),
                      Text(
                        "\$0.00",
                        style: TextStyle(
                          fontSize:
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Total", style: Textthemelight.textTheme.bodySmall),
                      Text(
                        "\$${Sendmoneyprovider.sendModel.sendingAmount}",
                        style: TextStyle(
                          fontSize:
              ...
              builder: (context, provider, child) {
                return Container(
                  ...
                  child: buttomprimary(
                    txt: "Confirm",
                    fun: () {
                      provider.addSendingOperation(Sendmoneyprovider.sendModel);
